...
> 当前阶段：正式配置 [`a10-cuda-smolvla-20260831-r1`](../experiments/a10-cuda-smolvla-20260831-r1/CONFIGURATION.md) 已完成正确性、性能基线与隔离稳态 profile，结果见 [RESULTS.md](../experiments/a10-cuda-smolvla-20260831-r1/RESULTS.md)。仍需主瓶颈确认与优化验证。活跃文档维护后续优化所需的规则、辅助资料和实验记录。
